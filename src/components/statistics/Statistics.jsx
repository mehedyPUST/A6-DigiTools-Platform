...
const Statistics = () => {
    return (
        <div className="  mx-auto bg-linear-to-t from-purple-700 to-purple-500 py-5 md:py-10">
            <div className="max-w-7xl mx-auto flex justify-between items-center text-white text-center">
                ...
                {/* Item 2 */}
                <div className="flex-1">
                    <h2 className="text-3xl md:text-4xl font-bold md:font-extrabold">200+</h2>
                ...
                {/* Item 3 */}
                <div className="flex-1">
                    <h2 className="text-3xl md:text-4xl font-bold md:font-extrabold">4.9</h2>
